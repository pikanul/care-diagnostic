...
class GlobalSetting extends Model
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'address_en' => 'Alhaj Mojibur Rahman Bhuiyan Complex, Hospital Road, Katiadi, Kishoreganj.',
            'address_bn' => 'আলহাজ মজিবুর রহমান ভূঁইয়া কমপ্লেক্স, হাসপাতাল রোড, কটিয়াদী, কিশোরগঞ্জ।',
            'phone_primary' => '01734762211',
            'phone_secondary' => null,
            'emergency_number' => '01734762211',
            'email' => 'info@carediagnostickatiadi.com',
            ...
            'whatsapp_link' => '#',
            'google_map_embed' => 'https://www.google.com/maps/search/?api=1&query=Alhaj%20Mojibur%20Rahman%20Bhuiyan%20Complex%2C%20Hospital%20Road%2C%20Katiadi%2C%20Kishoreganj',
            'seo_settings' => [
            ...
            'email_integration_settings' => [
                ...
                'from_name' => env('MAIL_FROM_NAME', 'Care Diagnostic & Physiotherapy Center'),
                'from_email' => env('MAIL_FROM_ADDRESS', 'info@carediagnostickatiadi.com'),
                'host' => env('MAIL_HOST'),
                'port' => env('MAIL_PORT'),
                'encryption' => env('MAIL_SCHEME', 'smtps'),
                'username' => env('MAIL_USERNAME'),
                'password' => env('MAIL_PASSWORD'),
                'api_key' => null,
                'reply_to' => env('MAIL_FROM_ADDRESS', 'info@carediagnostickatiadi.com'),
            ],
            'visitor_tracking_settings' => [
                'enabled' => true,
                'anonymize_ip' => false,
                ...
                'cookie_banner_text_en' => 'We use cookies to improve your experience and measure website performance.',
                'cookie_banner_text_bn' => 'ওয়েবসাইটের কার্যকারিতা বুঝতে এবং অভিজ্ঞতা উন্নত করতে আমরা কুকি ব্যবহার করি।',
