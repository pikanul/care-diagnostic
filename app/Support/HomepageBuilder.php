...
class HomepageBuilder
{
    public static function sections(): array
    {
        return [
            ...
            'hero-slider' => ['label_en' => 'Hero Slider', 'label_bn' => 'হিরো স্লাইডার', 'type' => 'slider'],
            ...
            'main-services' => ['label_en' => 'Main Services', 'label_bn' => 'প্রধান সেবা', 'type' => 'cards'],
            'quality-highlight-strip' => ['label_en' => 'Quality Highlight Strip', 'label_bn' => 'গুণমান হাইলাইট স্ট্রিপ', 'type' => 'strip'],
            'diagnostic-test-categories' => ['label_en' => 'Diagnostic Test Categories', 'label_bn' => 'ডায়াগনস্টিক টেস্ট বিভাগ', 'type' => 'cards'],
            ...
            return [
                ...
                'slides' => [
                    ...
                    [
                        ...
                        'title_bn' => 'সমন্বিত সেবা, আধুনিক প্রযুক্তি, সবশেষ নিরীক্ষা',
                        'subtitle_en' => 'Modern diagnostics, physiotherapy and patient-focused care under one roof.',
                        'subtitle_bn' => 'এক ছাদের নিচে আধুনিক ডায়াগনস্টিক, ফিজিওথেরাপি এবং রোগী-কেন্দ্রিক সেবা।',
                        'video_url' => null,
                        'primary_cta_label_en' => 'Explore Services',
                        'primary_cta_label_bn' => 'সেবা দেখুন',
                        'primary_cta_url' => '/en#main-services',
                        'secondary_cta_label_en' => 'Contact Us',
                        'secondary_cta_label_bn' => 'যোগাযোগ করুন',
                        'secondary_cta_url' => '/en#appointment-cta',
                    ],
                ],
            ];
        }
            ...
            return [
                ...
                'groups' => [
                    [
                        'title_en' => 'Hematology',
                        'title_bn' => 'হেমাটোলজি',
                        'tests_en' => ['CBC (Complete Blood Count)', 'ESR', 'Blood Grouping & Typing', 'Peripheral Smear', 'HbA1c'],
                        'tests_bn' => ['সিবিসি (সম্পূর্ণ রক্ত গণনা)', 'ইএসআর', 'রক্তের গ্রুপিং ও টাইপিং', 'পেরিফেরাল স্মিয়ার', 'এইচবিএ১সি'],
                    ],
                    [
                        'title_en' => 'Biochemistry',
                        'title_bn' => 'বায়োকেমিস্ট্রি',
                        'tests_en' => ['Blood Sugar (Fasting/PP)', 'Lipid Profile', 'Liver Function Test (LFT)', 'Kidney Function Test (RFT)', 'Electrolytes'],
                        'tests_bn' => ['রক্তে শর্করা (ফাস্টিং/পিপি)', 'লিপিড প্রোফাইল', 'লিভার ফাংশন টেস্ট (এলএফটি)', 'কিডনি ফাংশন টেস্ট (আরএফটি)', 'ইলেক্ট্রোলাইটস'],
                    ],
                    [
                        'title_en' => 'Serology & Immunology',
                        'title_bn' => 'সেরোলজি ও ইমিউনোলজি',
                        'tests_en' => ['Viral Test', 'Dengue NS1 / IgG / IgM', 'HBs Ag', 'Anti HCV', 'VDRL / PPR'],
                        'tests_bn' => ['ভাইরাল টেস্ট', 'ডেঙ্গু NS1 / IgG / IgM', 'HBs Ag', 'অ্যান্টি HCV', 'ভিডিআরএল / পিপিআর'],
                    ],
                    [
                        'title_en' => 'Urine & Stool',
                        'title_bn' => 'পেশাব ও মল পরীক্ষা',
                        'tests_en' => ['Urine R/E', 'Stool R/E', 'Stool for Occult Blood', 'Urine Culture'],
                        'tests_bn' => ['ইউরিন আর/ই', 'স্টুল আর/ই', 'অকোল্ট ব্লাডের জন্য স্টুল', 'ইউরিন কালচার'],
                    ],
                    [
                        'title_en' => 'Others',
                        'title_bn' => 'অন্যান্য',
                        'tests_en' => ['ECG', 'X-Ray', 'Ultrasound', 'Sputum for AFB', 'Audiometry'],
                        'tests_bn' => ['ইসিজি', 'এক্স-রে', 'আলট্রাসাউন্ড', 'এএফবি-এর জন্য স্পুটাম', 'অডিওমেট্রি'],
                    ],
                ],
                'cta' => [
                    'title_en' => 'Accurate Tests, Reliable Results',
